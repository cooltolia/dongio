const $$ = {
    ...
    /** @param {HTMLElement} el */
    slideDown(el, { speed = 120, display = 'block' } = {}) {
        let resolve, reject;
    ...
    slideToggle(el, { speed = 120, display = 'block' } = {}) {
        if ($$.isHidden(el)) {
     ...
     *     }
     */
    showModal(id, { onShow = null, onClose = null, removeOnClose = false } = {}) {
        MicroModal.show(id, {
            disableScroll: true,
            disableFocus: true,
